...
if type$ = "Sound"
	# If this is a Sound editor, we need to select the Sound object.
	...
	# If this is a TextGrid editor, we need to select the TextGrid and Sound objects that are open in the TextGridEditor.
...
# remove the Sound object created if this was loaded from a TextGridEditor
if type$ = "TextGrid"
	selectObject: sndObj
	Remove
endif