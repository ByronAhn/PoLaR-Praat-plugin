################################################################
###  
### PoLaR-pseudo-to-slopes-Dir
###
###		>> Please ensure you have Praat v.6.1 or greater
###
### Runs PoLaR-pseudo-to-slopes-CORE.praat
### with the settings defined in PoLaR-pseudo-to-slopes-Quick-Settings.praat.
### on a whole directory of .wav and .Textgrid files.
###
### For more information, see PoLaR-pseudo-to-slopes-CORE.praat.
###
################################################################
...
if create_A_Single_Output_File = 1
	...
	output_File_Name$ = "Info-for-PoLaR-Pseudo-labels.tsv"
